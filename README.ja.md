...
実際のアプリで、完成した絵コンテから手動フレーム選択画面を開き、視覚的なタイムラインで場面を探して候補から一コマを選び、保存する流れです。

![ShotTessera のワークスペースから手動フレーム選択画面へ移り、絵コンテ、視覚タイムライン、候補ギャラリーを表示する操作](docs/assets/video-to-storyboard-demo.gif)
